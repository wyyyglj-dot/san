...
export type SidebarView = 'overview' | 'script-parse' | 'storyboard' | 'assets' | 'export' | 'settings';
...
const sidebarItems: (SidebarItem | { type: 'separator' })[] = [
...
export function EpisodeSidebar({
  ...
  return (
    ...
    >
      <div className="flex h-12 items-center justify-end px-2 border-b border-white/[0.04]">
        <Button
          variant="ghost"
          size="icon"
