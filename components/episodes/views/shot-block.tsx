    ...
    <li className="flex gap-4 p-4 hover:bg-accent/5 transition-colors group relative focus-within:bg-accent/[0.03]">
      ...
      {onMergeUp ? (
        <button
          ...
          title="合并到上一个分镜"
          onClick={() => onMergeUp()}
          className="shrink-0 p-1 rounded opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus:opacity-100 text-foreground/30 hover:text-foreground/60 hover:bg-accent/10 disabled:opacity-0 disabled:pointer-events-none transition-all"
        >
