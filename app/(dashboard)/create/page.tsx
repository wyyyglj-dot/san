    ...
    <div className="flex flex-col h-[calc(100vh-100px)] max-w-7xl mx-auto">
      ...
      <div className={cn(
        ...
        <PromptConfigurator
          ...
          files={files}
          showFileUpload={mediaType === 'image' ? !!currentImageModel?.features.imageToImage : true}
          ...
          isOmniReference={mediaType === 'video' && !!currentVideoModel?.features.omniReference}
          omniSubjects={omniSubjects}
          onOmniSubjectsChange={setOmniSubjects}
        />
