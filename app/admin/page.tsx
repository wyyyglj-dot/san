    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, index) => (
          <div 
            key={index}
            className="bg-card/40 backdrop-blur-sm border border-white/[0.06] rounded-2xl p-5 hover:border-white/[0.06] transition-all duration-300"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {quickLinks.map((item) => (
            <Link key={item.href} href={item.href}>
              <div className="bg-card/40 backdrop-blur-sm border border-white/[0.06] rounded-2xl p-5 hover:border-white/[0.06] hover:bg-card/50 transition-all duration-300 group h-full">
      ...
      {isAdmin && (
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/users" className="text-sm text-foreground/50 hover:text-foreground/65 transition-colors">
              查看全部 →
            </Link>
          </div>
              ...
              <table className="w-full min-w-[640px]">
                ...
                <tbody>
                  {users.slice(0, 5).map((user) => (
                    <tr key={user.id} className="border-b border-white/[0.06] last:border-0 hover:bg-card/40 transition-colors">
