...
import {
  ...
  AlertCircle, Check, X, Edit2, Power, Layers
} from 'lucide-react';
...
export default function ModelsPage() {
  ...
  return (
    <AdminPageLayout title="聊天模型" description="配置 OpenAI 兼容的聊天模型" icon={Layers}>
      {/* Form */}
      <div className="bg-card/40 border border-white/[0.06] rounded-2xl p-6 space-y-4">
        ...
        <div className="flex items-center gap-3 pt-4">
          ...
          {editingId && (
            <button
              onClick={resetForm}
              className="px-5 py-2.5 bg-card/50 text-foreground rounded-xl hover:bg-card/65"
            >
              取消
            </button>
          )}
        ...
        <div className="overflow-x-auto no-scrollbar">
          ...
          <thead>
            <tr className="border-b border-white/[0.06]">
              ...
              <th className="text-left text-sm font-medium text-foreground/50 px-5 py-4">接口地址</th>
          ...
          <tbody>
            {models.map((model) => (
              <tr key={model.id} className="border-b border-white/[0.06] hover:bg-card/40">
                ...
                <td className="px-5 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button
                      ...
                      className="p-2 text-foreground/40 hover:text-foreground hover:bg-card/50 rounded-lg"
                    >
