      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-12 animate-rise">
          ...
          <div className="chip backdrop-blur-sm animate-float">
            ...
            <span className="text-sm text-foreground/55">AI 创作平台</span>
          </div>
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            <h2 className="text-xl md:text-2xl font-light text-foreground/65">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <div className="surface group flex items-center gap-3 px-5 py-4 backdrop-blur-sm transition-all hover:-translate-y-0.5">
              <div className="w-10 h-10 bg-card/50 border border-white/[0.06] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Button 
              size="lg" 
              variant="ghost" 
              className="text-foreground/55 hover:text-foreground hover:bg-card/50 px-8 h-12 text-base rounded-full border border-white/[0.06]" 
              asChild
            >
